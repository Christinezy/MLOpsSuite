...
def trans(model, BPE_path, source_lang, target_lang, filename, output_path):
    ...
    print(model)
    #parser = get_parser()
    lparser = parser.parse_args(['--model_path', model,'--src_lang', source_lang, '--tgt_lang', target_lang, '--BPE_path', BPE_path])
    ...
    with open(filename, 'r') as filen:
        ...
        with open(f'{output_path}'+filetype, 'w') as file_out:
            for out in output:
                file_out.write(out)
...
if __name__ == "__main__":
    ...
    print(**params)
    trans(params.model_path, params.BPE_path, 
        params.src_lang, params.tgt_lang,
        params.filepath, params.target_path
        )

    # trans(params.model_path, params.BPE_path, 
    #     'python','java',
    #     './mlops_files/project_1/version_3/python_code.py', "./mlops_files/project_1/version_3/python_java.java")
